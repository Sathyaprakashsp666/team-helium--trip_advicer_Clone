            ...
            <div className="footer-terms-conditions">
                <div className="footer-t&c-info">
                    <div className="footer-t-c-info-logo">
                        <img src="https://static.tacdn.com/img2/brand_refresh/Tripadvisor_logoset_solid_green.svg" alt="logo_image"/>
                    </div>
                    ...
                    <div className="footer-t-c-links">
                        ...
                        <Link className="terms-cond-link-styles">Privacy and Cookies Statement</Link>
                ...
                <div>
                    <p className="copyright-info">This is the version of our website addressed to speakers of English in India. If you are a resident of another country or region, please select the appropriate version of Tripadvisor for your country or region in the drop-down menu. <Link className="more">more</Link></p>
                </div>
            </div>
